    ...
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            <div class="content-pad">
                ...
                <div class="form-card">
                    <h3 class="form-title">
                        {{ editingId ? 'Edit Manga' : 'Add to Catalog' }}
                    </h3>
                ...
                <div class="section-header">
                    ...
                    <span class="count-badge" v-if="mangas.length">{{
                        mangas.length
                    }}</span>
                </div>
                ...
                <div v-else>
                    ...
                    >
                        ...
                        <div class="manga-info">
                            ...
                            <span class="manga-ch" v-if="manga.total_chapters"
                                >{{ manga.total_chapters }} chapters</span
                            >
                        </div>
                        <div class="manga-actions">
                            <button
                                class="action-btn edit-btn"
                                @click="startEdit(manga)"
                            >
    ...
    methods: {
        ...
        async updateManga() {
            ...
            try {
                ...
                const idx = this.mangas.findIndex(
                    (m) => m.id === this.editingId
                );
