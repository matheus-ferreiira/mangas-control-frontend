        ...
        <div class="detail-body">
          ...
          <div class="stats-row">
            <div class="stat-item">
              ...
              <span class="stat-value">Ch. {{ item.current_chapter }}</span>
            </div>
            <div class="stat-divider"></div>
            <div class="stat-item">
              <span class="stat-label">Total</span>
              <span class="stat-value">
                {{ item.manga?.total_chapters ? `Ch. ${item.manga.total_chapters}` : '—' }}
              </span>
            </div>
            <div class="stat-divider"></div>
            <div class="stat-item">
          ...
          <div class="section-block">
            ...
            <div class="chapter-controls">
              <button class="ctrl-btn" @click="decrement" :disabled="saving">
              ...
              <div class="chapter-display">
                <input
                  ...
                  min="0"
                />
                <span v-else class="chapter-number" @click="startEditChapter">
                  {{ item.current_chapter }}
                </span>
                <span class="chapter-sub">Tap to edit</span>
              </div>
              <button class="ctrl-btn ctrl-add" @click="increment" :disabled="saving">
          ...
          <div class="section-block" v-if="sites.length">
            ...
            <div class="site-select-wrap">
              <select v-model="selectedSiteId" class="site-select" @change="changeSite">
