        ...
        <ion-content :fullscreen="true">
            ...
            <div class="hero-section">
                ...
                <div class="hero-overlay">
                    ...
                    <p class="hero-sub">
                        Initialize a new series in the neon archives. Every
                        volume is a legacy.
                    </p>
                </div>
            </div>
            ...
            <div class="form-body">
                ...
                <div class="curator-note">
                    ...
                    <p class="note-text">
                        "The quality of the metadata defines the clarity of the
                        collection. Ensure high-resolution imagery for the
                        digital shelf."
                    </p>
                </div>
                ...
                <div class="form-section">
                    <div class="field-group">
                        ...
                        <div v-else class="input-row">
                            <ion-icon
                                :icon="bookOutline"
                                class="field-icon-abs"
                            />
                            <input
                                v-model="form.manga_name"
                    ...
                    <div class="field-group">
                        ...
                        <span class="field-hint"
                            >Suggested: High-resolution vertical assets (minimum
                            800×1200px)</span
                        >
                    </div>

                    <div class="field-group">
                        <span class="neon-label"
                            >Total Chapters (Optional)</span
                        >
                        <div class="input-row">
                            <ion-icon
                                :icon="layersOutline"
                    ...
                    <div class="field-group">
                        ...
                        <div class="input-row">
                            ...
                            />
                            <input
                                v-model.number="form.current_chapter"
                                type="number"
                                placeholder="0"
                                class="field-input"
                                min="0"
...
export default defineComponent({
    ...
    methods: {
        ...
        async addManga() {
            this.saving = true;
            try {
                let mangaId = this.form.manga_id
                    ? Number(this.form.manga_id)
                    : null;
