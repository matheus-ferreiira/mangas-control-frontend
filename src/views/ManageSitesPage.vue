    ...
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <div class="hero-section">
                ...
                <p class="hero-sub">
                    Integrate new manga sources into your curator's cloud. Our
                    system will index metadata and chapter updates
                    automatically.
                </p>
            </div>
            ...
            <div class="page-body">
                ...
                <div class="form-card">
                    ...
                    <p class="form-disclaimer">
                        By adding a source, you confirm that the URL points to a
                        valid web archive. Encrypted synchronization will begin
                        immediately.
                    </p>
                </div>
                ...
                <div class="sites-section">
                    <div class="section-header">
                        ...
                        <span class="count-badge" v-if="sites.length">{{
                            sites.length
                        }}</span>
                    </div>
    ...
    methods: {
        ...
        async updateSite() {
            ...
            try {
                ...
                const idx = this.sites.findIndex(
